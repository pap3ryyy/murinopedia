## ufql по запуску Муринопедии (pap3ryyy, 4 мая 2026)

код — говнокод. Проект перегорел, поддерживать я его больше не буду, но вы можете поднять копию. Всё ниже написано предельно прямо, без украшений. Местами будет больно, но оно работает.
